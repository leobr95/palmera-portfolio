...
export default function PortfolioPublicPage() {
  ...
  // ✅ usa strings como “fuente de verdad” (evita que cambie por referencia sp)
  ...
  // ====== Editor: categorías presentes (memo)
  ...
  // ✅ FIX ESLINT: memoizar estos arrays (evita que cambien por referencia en cada render)
  ...
  // ✅ Reset de órdenes SOLO cuando cambian realmente los servicios/cats (sin loop)
  useEffect(() => {
    // categoryOrder
    ...
    // si quieres resetear colapsados cuando cambie el set de categorías:
    // setCollapsedCats({});
  }, [presentCats, selectedServices]);
